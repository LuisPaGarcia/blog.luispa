---
slug: captures-console-log-into-a-react-component
title: Captures console.log's into a React Component
date: 2020-02-06
author: luispa
tags:
  - document
...
Head over to `http://localhost:3000` in your browser, and you'll see the demo page come up. After you make changes you'll need to reload, but th